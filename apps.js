...
}    else if(request.url === '/images/gtr2.jpg'){
    // notice we won't include the utf8 encoding
    fs.readFile('./images/gtr2.jpg', function(errors, contents){
        response.writeHead(200, {'Content-type': 'image/jpg'});
        response.write(contents);
        response.end();
    })
}
    else if(request.url === '/images/engine.jpg'){
    // notice we won't include the utf8 encoding
    fs.readFile('./images/engine.jpg', function(errors, contents){
        response.writeHead(200, {'Content-type': 'image/jpg'});
        response.write(contents);
        response.end();
    })
